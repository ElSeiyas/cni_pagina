            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="buttons.html"><i class=" far fad fa-file-user"></i>
                    <span>ADMISION 2021</span></a>
                        <a class="collapse-item" href="cards.html"><i class="fas fad fa-tasks"></i>
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                       <!-- <h6 class="collapse-header">Custom Utilities:</h6>-->
                        <a class="collapse-item" href="incidencias.php"><i class=" fas fa-file-search"></i>
