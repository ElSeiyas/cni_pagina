...
<head>
    ...
    <title>BASE DE DATOS DE INCIDENCIAS</title>
    ...
    <link rel="stylesheet"  type="text/css" href="vendor/datatables/DataTables-1.10.23/css/dataTables.bootstrap4.min.css">
        ...
        <link rel='stylesheet prefetch' href='https://cdnjs.cloudflare.com/ajax/libs/bootstrap-select/1.13.18/css/bootstrap-select.min.css'>
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                       <!-- <h6 class="collapse-header">Custom Utilities:</h6>-->
                         <a class="collapse-item" href="#">  <i class="fas fa-fw fa-file-alt"></i>
...
?>
 ...
 <div class="container">
    ...
    <h1 align="center">BASE DE DATOS DE INCIDENCIAS</h1>
  ...
  <div class="form-group">
   ...
   <input required="" type="file" name="file" id="exampleInputFile">
           ...
           <button class="btn btn-success" type="submit"  onclick="confirmar5()" >Cargar archivo</button>
                 </form>
    ...
    <tr>
      ...
      <td><?php echo $archivos[$i]; ?></td>
        <td>    
            ...
            <a href="subidas/<?php echo $archivos[$i]; ?>" download="<?php echo $archivos[$i]; ?>" class="btn btn-success"><span class="fa fa-download"></span></a>
       ...
       <td> 
             <div class="container">
                <div class="row">
                    <div class="col text-center">
                        <a href="Eliminar.php?name=subidas/<?php echo $archivos[$i]; ?>" class="btn btn-danger" onclick="confirmar2()"><span class="fas fa-trash"></span> </a>
...
<!-- código JS propìo--> 
<script type="text/javascript" src="main_incidencias.js"></script> 
