...
<head>
    ...
    <title>USUARIOS AUTORIZADOS</title>
...
?>
    ...
    ?>
        ...
        <div class="container">
    <h1 align="center">USUARIOS AUTORIZADOS</h1>


<div class="container">
	<div class="row">
	<div class="col-lg-12">
			<a href="#addnew" class="btn btn-success" data-toggle="modal"><span class="glyphicon glyphicon-plus"></span> Nuevo Usuario</a>
 </div>    
    </div>    
    </div>    
    <br>  
			...
			try{	
				...
				foreach ($db->query($sql) as $row) {
					...
					<tr>
                       ...
                       <td ><img   width = " 50 "  height="50" style="border-radius:150px" src = " data: <?php   ?> ; base64, <?php  echo   base64_encode ( $row[ 'foto' ]); ?> " ></td>
						...
						<?php include('Borrar_Editar_Modal.php'); ?>
					</tr>
					<?php 
				}
			}
...
<!-- código JS propìo--> 
<script type="text/javascript" src="main_usuarios.js"></script> 
