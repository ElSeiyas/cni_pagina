            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    ...
                    <span>ADMISION 2021</span></a>
                        <a class="collapse-item" href="#"><i class="fas fad fa-tasks"></i>
...
?>
      <div class="container">
                   ...
                   <h1 align="center"> RECEPCION DE MESA MESA DE PARTES</h1>
...
<table id="example25" class="table table-striped table-bordered table-condensed display nowrap"  style="width:100%">
	...
	<thead class="text-center">
                ...
                <div class="row">
                    <div class="col text-center">
                        ...
                        <a class="btn btn-warning btn-sm" target="_black" href="<?php echo 'http://' . $_SERVER['HTTP_HOST'] . '/formulario_mesa_de_partes/' . $val['url']; ?>" ><span class="fas fa-fw fa-file-alt"></span></a>
                         </div>
              </div>
                </div>
                                    </td>
                ...
                <div class="row">
                    <div class="col text-center">
                                         <a href="#edit_<?php echo $val['id']; ?>"  class="btn btn-success btn-sm" data-toggle="modal"><span class="fas fa-edit"></span></a>
                                        
                                        <a href="#delete_<?php echo $val['id']; ?>"class="btn btn-danger btn-sm"  data-toggle="modal"><span class="fa fa-trash"></span></a>
                                               </div>
              </div>
                </div>
                        
                                        </td>
                                        <?php include('Borrar_Editar_Modal_mesa.php'); ?>
...
<!-- código JS propìo--> 
<script type="text/javascript" src="main_mesa.js"></script> 
<script src="https://cdn.jsdelivr.net/npm/sweetalert2@10"></script>
<script type="text/javascript">
    function confirmar1(){
Swal.fire({
